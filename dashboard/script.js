const fichas = document.querySelectorAll(".editficha");
...
const npcs = document.querySelectorAll(".editnpc");
npcs.forEach((npc) => {
...
const missoes = document.querySelectorAll(".editmissao");
missoes.forEach((missao) => {
    ...
    <div class="modal-content-enredo">
        <div class="input-group-enredo">
            <label>Enredo</label>
            <input type="text" placeholder="Digite o enredo aqui...">
        </div>
